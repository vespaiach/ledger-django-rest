...
class CreateTransactionTest(TestCase):
    ...
    def test_create_transaction_success(self):
        tx = create_transaction(self.user.id, 100, "2022-04-20 00:00:00.000+00:00", "tips", ["bonus", "tips"])
    ...
    def test_create_transaction_missing_reason(self):
        with self.assertRaises(ValidationError):
            create_transaction(
                self.user.id, amount=100, date="2022-04-20 00:00:00.00000 +00:00", note="tips", reasons=[]
            )
    ...
    def test_create_too_long_note_transaction(self):
        with self.assertRaises(ValidationError):
            create_transaction(
                self.user.id,
                amount=100,
                date="2022-04-20 00:00:00.00000 +00:00",
                note="too long text" * 200,
                reasons=["test"],
            )
...
class UpdateTransactionTest(TestCase):
    ...
    def test_update_transaction_success(self):
        update_transaction(
            ...
            user_id=1,
            amount=70000,
            date="2022-04-21 00:00:00.000+00:00",
            note="paychecks",
            reasons=["compensate"],
        )
        ...
        self.assertEqual(tx.date, datetime.fromisoformat("2022-04-21 00:00:00.000+00:00"))
...
class QueryTransactionTest(TestCase):
    ...
    def test_query_transaction_by_date(self):
        transactions, total_page, total_record = get_transactions(
            user_id=1, from_date="2022-04-20 00:00:00.000+00:00", to_date="2022-04-23 00:00:00+00:00"
        )
    ...
    def test_query_income_transaction(self):
        transactions, total_page, total_record = get_transactions(user_id=1, from_amount=0)
    ...
    def test_query_expense_transaction(self):
        transactions, total_page, total_record = get_transactions(user_id=1, to_amount=0)
    ...
    def test_query_transaction_by_single_reason(self):
        transactions, total_page, total_record = get_transactions(user_id=1, reasons=["salary"])
