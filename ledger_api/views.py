...
from ledger_api.validations import GetTransactionsForm, OnlyIdTransactionsForm, PostTransactionsForm, PutTransactionsForm
...
class TransactionsView(APIBaseView):
    def get(self, request):
        ...
        form = GetTransactionsForm(request.GET, initial={
                                   "page": 1, "per_page": 50})
