...
class TokenTest(APITestCase):
    ...
    def test_request_token_with_missing_fields(self):
        c = Client()
        response = c.post("/api/token", {"password": "123"}, content_type="application/json")
    ...
    def test_revoke_token(self):
        ...
        revoke_response = c.delete("/api/token", content_type="application/json", authorization=token)
